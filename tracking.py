...
# =====================================================
# 1. PARÁMETROS DE CALIBRACIÓN (PEGA AQUÍ LOS TUYOS)
# =====================================================
# Matriz intrínseca (ejemplo basado en tu captura)
K = np.array([
...
# =====================================================
# 2. RANGOS HSV (PELota NARANJA Y ARO AZUL)
# =====================================================
...
def detect_orange_ball(hsv_frame, min_area=800):
    ...
    # Opcional: pequeñas operaciones morfológicas para limpiar ruido
...
def main(camera_index=0):
    ...
    # Leemos una vez para obtener tamaño y precomputar mapas de undistort
    ret, frame = cap.read()
    if not ret:
    ...
    # Matriz nueva (podemos usar alpha=1 para mantener todo el FOV)
    ...
    while not hoop_found and hoop_search_count < max_hoop_search_frames:
        ...
        cv2.putText(undistorted, "Buscando aro azul...", (30, 40),
